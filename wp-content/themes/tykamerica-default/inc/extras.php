		...
		<nav class="container navigation post-navigation">
			...
			<div class="row nav-links justify-content-between">
				...
				if ( get_previous_post_link() ) {
					previous_post_link( '<span class="nav-previous">%link</span>', _x( '<i class="fa fa-arrow-left"></i>&nbsp;Previous<br><span>%title</span>', 'Previous post link', 'understrap' ) );
				}
				if ( get_next_post_link() ) {
					next_post_link( '<span class="nav-next">%link</span>', _x( 'Next&nbsp;<i class="fa fa-arrow-right"></i><br><span>%title</span>', 'Next post link', 'understrap' ) );
				}
				?>
			</div><!-- .nav-links -->
		</nav><!-- .navigation -->
