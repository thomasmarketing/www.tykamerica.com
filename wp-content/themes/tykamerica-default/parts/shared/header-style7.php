<header class="site-header header0 header7">
			...
			<div class="container">
				...
				<div class="utility-nav navbar-right">
					...
					if( $rfq_link ): 
					    ...
					    ?>
					    <a class="btn btn-primary d-none d-md-inline-block m-0" href="<?php echo esc_url( $rfq_link_url ); ?>" target="<?php echo esc_attr( $rfq_link_target ); ?>"><?php echo esc_html( $rfq_link_title ); ?></a>
					    <a class="btn btn-secondary d-md-none px-4 m-0" href="<?php echo esc_url( $rfq_link_url ); ?>" target="<?php echo esc_attr( $rfq_link_target ); ?>">RFQ</a>
					<?php endif; ?>
				</div>
